...
namespace Freya {
	...
	public static class Mathfs {
		...
		/// <summary>Returns base to the power of exponent</summary>
		...
		/// <summary>Returns the value clamped between -1 and 1</summary>
		...
		/// <summary>Rounds the vector components up to the nearest integer</summary>
		public static Vector4 Ceil( Vector4 value ) => new Vector4( (float)Math.Ceiling( value.x ), (float)Math.Ceiling( value.y ), (float)Math.Ceiling( value.z ), (float)Math.Ceiling( value.w ) );
		...
		/// <summary>Returns the fractional part of the value. Equivalent to x - floor(x).</summary>
		public static float Frac( float x ) => x - Floor( x );

		/// <summary>Returns the fractional part of the value for each component. Equivalent to x - floor(x).</summary>
		...
		/// <summary>Modulo, but, behaves the way you want with negative values, for stuff like [n+1] and [n-1] mod array length etc.</summary>
		...
		/// <summary>Applies cubic smoothing to the 0-1 interval. Similar to an EaseInOut operation</summary>
		public static float Smooth01( float x ) => x * x * ( 3 - 2 * x );

		/// <summary>Applies quintic smoothing to the 0-1 interval, smoother than Smooth01. Similar to an EaseInOut operation</summary>
		...
		/// <summary>Returns the normalized direction vector from one position to another</summary>
		...
		/// <summary>Returns the vector going from one position to another, also known as the displacement</summary>
		...
		/// <summary>Returns the halfway direction between the two input direction vectors. Note that this presumes both <c>aDir</c> and <c>bDir</c> have the same length</summary>
		...
		/// <summary>Returns the angle of the input vector, in radians</summary>
		/// <param name="dir">The direction to get the angle of. It does not have to be normalized</param>
